...
|---:|---|---|---:|
| 1 | `attempts/claude-opus-20260131/` | Opus 4.5 | 100 |
| 2 | `attempts/codex-gpt52-20260131/` | gpt-5.2-high | 99 |
| 3 | `attempts/opencode-20250131/` | kimi-k2.5 | 92 |
| 4 | `attempts/gemini-cli-2026-01-31/` | gemini-3-pro-preview | 89 |

Notes:
- **Claude (100)**: Best alignment with T2 safe-mode expectations (early exit before importing API-related packages) and strong T3 edge-case handling (no “correct” models case).
- **Codex (99)**: Strong overall and stricter validation in T1; minor deduction for re-implementing unevaluated-model detection in `--dry-run` rather than reusing `find_unevaluated_models()`.
...
- **Gemini (89)**: Similar safe-mode dependency issue as OpenCode; submission patch also triggers trailing whitespace warnings on apply (`attempts/gemini-cli-2026-01-31/SUBMISSION.patch`).
